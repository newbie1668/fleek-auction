...
A seller can configure and publish an auction without waiting for buyer messages.



A buyer can approve a private maximum and let a proxy agent bid automatically.



A competing buyer changes the public price without exposing either buyer's maximum.



Buy Now provides an immediate alternative to waiting.



The auction closes at the correct price and moves to Pending Fleek QC.
...
Verified supplier · 4.8 ★ · 312 orders
...
Baseline visible result



Primary leads at £660





Alternate rival maximum
...
Primary approves £690 → current price £620, primary leads, reserve met.



Rival £650 → current price £660, primary still leads.



Rival £710 instead → current price £700, rival leads.



Buy Now → closed at £760, Pending Fleek QC.
